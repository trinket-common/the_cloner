...
# Setup
echo "${CLONE} ${STAGING} ${GITHUB}/${TRINKET_COMMON}/${REPO_DEVICE} ${PATH_DEVICE}"
echo "${CLONE} ${STAGING} ${GITHUB}/${TRINKET_COMMON}/${REPO_DEVICE_COMMON} ${PATH_DEVIE_COMMON}"
echo "${CLONE} ${STAGING} ${GITHUB}/${TRINKET_COMMON}/${REPO_VENDOR} ${PATH_VENDOR}"
echo "${CLONE} ${STAGING} ${GITHUB}/${TRINKET_COMMON}/${REPO_VENDOR_COMMON} ${PATH_VENDOR_COMMON}"
echo "${CLONE} ${STAGING} ${GITHUB}/${TRINKET_COMMON}/${REPO_KERNEL} ${PATH_KERNEL}"
echo "${CLONE} ${STAGING} ${GITHUB}/${TRINKET_COMMON}/${REPO_SEPOLICY} ${PATH_SEPOLICY}"
